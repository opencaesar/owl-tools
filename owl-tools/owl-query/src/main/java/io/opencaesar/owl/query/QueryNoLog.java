...
public class QueryNoLog {
	...
	*/
	public static void execute(final String... args) {
		final QueryNoLog app = new QueryNoLog();
	...
	public void run() throws Exception {
		...
		*/
		System.out.println("Owl Query start");
	...
	private String getOutType(String formatType) {
		switch (formatType.toLowerCase()) {
			...
			default:
				...
				System.err.println(formatType + " is not a valid output type for describe/construct queries. Please use xml, n3, n-triple or ttl");
				System.exit(1);
				return "NULL";
		}
	}
	...
	private ResultsFormat getSelectType (String formatType) {
		switch (formatType.toLowerCase()) {
			...
			default:
				...
				System.err.println(formatType + " is not a valid output format for select queries. Please use one of the listed formats: xml, ttl, csv, json, tsv");
				System.exit(1);
