...
import static io.opencaesar.closetaxonomy.Axiom.ClassExpressionSetAxiom.DisjointClassesAxiom;
import static io.opencaesar.closetaxonomy.Axiom.ClassExpressionSetAxiom.DisjointUnionAxiom;
...
public class Taxonomy extends DirectedAcyclicGraph<ClassExpression, Taxonomy.TaxonomyEdge> {
	 ...
	 * @return List<Axiom>
	 */
	public Set<Axiom> generateClosureAxioms(io.opencaesar.closetaxonomy.Axiom.AxiomType axiomType) throws UnconnectedTaxonomyException, InvalidTreeException {
