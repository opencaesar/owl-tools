...
name 'every subproperty of O:topReifiedObjectPropertyTarget is part of a reification rule'
...
query %q{
  ...
  where {
    ...
    bind(iri(concat("http://imce.jpl.nasa.gov/backbone/", strafter(str(?graph), "http://"), "#topReifiedObjectPropertyTarget")) as ?top)
