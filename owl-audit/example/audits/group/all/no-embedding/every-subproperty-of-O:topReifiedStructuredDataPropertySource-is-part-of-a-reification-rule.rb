...
name 'every subproperty of O:topReifiedStructuredDataPropertySource is part of a reification rule'
...
query %Q{
  ...
  where {
    ...
    bind(iri(concat("http://imce.jpl.nasa.gov/backbone/", strafter(str(?graph), "http://"), "#topReifiedStructuredDataPropertySource")) as ?top)
