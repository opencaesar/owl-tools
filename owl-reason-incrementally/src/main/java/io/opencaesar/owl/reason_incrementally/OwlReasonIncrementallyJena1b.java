 ...
 */
public class OwlReasonIncrementallyJena1b {
	...
	private final static Logger LOGGER = Log.getLogger(OwlReasonIncrementallyJena1b.class, Level.ALL);
	static {
	...
	public static void main(String[] args) throws Exception {
		final OwlReasonIncrementallyJena1b app = new OwlReasonIncrementallyJena1b();
	...
	public OwlReasonIncrementallyJena1b() {
	}
